...
def test_get_categories(mock_db_cursor):
    doc = Documents()
    mock_db_cursor.fetchall.return_value = [('Cards',), ('Student',), ('Insurance',), ('For parents',), ('Refugee',), ('Citizenship',)]  # Replace with expected return value
    result = doc.getCategories()
    assert result == [('Cards',), ('Student',), ('Insurance',), ('For parents',), ('Refugee',), ('Citizenship',)]
